  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-display font-bold tracking-tight">Inventory</h2>
          <p className="text-xs text-muted-foreground font-body mt-0.5">Manage your stock</p>
        </div>
      ...
      <Tabs defaultValue="all" className="space-y-6">
        ...
        <TabsContent value="all" className="mt-0">{renderGrid(items)}</TabsContent>
